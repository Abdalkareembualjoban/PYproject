...
@section('page-name','Create client')
@section('main-page','Human Resources')
@section('sub-page','clients')
@section('page-name-small','Create client')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            ...
                            <span class="form-text text-muted">Please enter your identification num</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Active client</label>
                        <div class="col-3">
